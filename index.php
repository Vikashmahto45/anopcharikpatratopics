...
<section class="hero-redesign">
    <div class="hero-content">
        ...
        <div class="cta-group">
            <a href="#examples" class="cta-btn-primary">View Patra Examples Directly <span
                    style="font-size: 0.7rem; background: var(--brand-dark); color: white; padding: 2px 8px; border-radius: 20px; vertical-align: middle; margin-left: 5px;">INSTANT</span></a>
            <a href="<?php echo url('patra-master-bank.php'); ?>" class="cta-btn-outline">Explore Grammar Hubs</a>
        </div>
    </div>
</section>
