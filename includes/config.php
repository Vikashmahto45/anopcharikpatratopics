...
function get_seo_data($pdo, $filename) {
    ...
    return [
        ...
        'meta_description' => 'Anopcharik Patra Topics provides comprehensive guides and 1,000+ word detailed examples on writing informal letters in Hindi and English.',
